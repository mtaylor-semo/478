...
\begin{quote}
\textbf{Hiodontiformes (13)}: Teeth on bony tongues. Ventral keel present.* Anal fin fewer than 40 rays.* 

\textbf{Notopteriformes (14)}: Teeth on bony tongues. Ventral keel absent.* Anal fin combined with caudal fin, with 100 or more total rays.
...
\textbf{Division Teleostei (con't)}
...
\textbf{Gasterosteiformes (48)}: Body usually with rings or plates
of armor. Mouth usually small. Syngnathidae (48).
...
jugular. Sciaenidae (55), Pomacentridae (58), Blenniidae (60).%, Osphronemidae (65).
