...
\begin{frame}[t,plain]{This field guide is \highlight{recommended} for this course.}
	\begin{center}
		\vspace{-\baselineskip}
...
\highlight{16–19 February 2024.} \hfill Campus eBird stations do \emph{not} count as \textsc{gbbc.}
