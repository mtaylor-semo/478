...
\fancypagestyle{plain}{%
	...
	\rhead{Fish assemblage diversity}
...
%\textbf{This assignment is worth 50 points. You must upload your Word \emph{and} Excel files to the specified drop box by the due date.}
