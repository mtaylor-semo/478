...
\begin{enumerate}
	...
	\item Figures: Like tables, figures are numbered in the order that they are referenced in your text.  Figure 1 should appear first, Figure 2, second, and so on.  Unlike tables, the figure legend appears below the figure, beginning with the figure number.  
