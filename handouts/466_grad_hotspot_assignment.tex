...
\begin{itemize}
%This is in effect for 2026. No birding in May
\item You must bird at your hotspot in January, February, March, and April. \textsc{Note:} Due to the academic calendar, May is not available for 2026. 

\item You must bird at your hotspot at least two hours in February through April. You are only required to bird for one hour in January.

\item You can do all hours for each month in a single visit or you can spread the time across multiple visits. Multiple visits each month will increase the chances of seeing more species \emph{and} give you a better sense of when birds are departing and arriving via migration.

\item You can earn 20 points per month for February, March, and April, and 10 points for January.

% Below is normal years
%\item You must bird at your hotspot in February, March, April, and either January or May (\textsc{May is not available for 2026.}). 
...
Points for January %or May 
will be awarded with this rubric:
