...
\begin{frame}{Strigiformes: \highlight{Strigidae} — Great Horned and Barred owls.}
...
\tinyfill \href{https://commons.wikimedia.org/wiki/File:American_Kestrel_(Male)_(8238822396).jpg}{Andy Morffew, \ccby{2.0}}
\end{frame}
}
