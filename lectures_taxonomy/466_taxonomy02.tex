...
\draw[ultra thick, black] (4.8, 0.25) -- (4.8, 1.45) node[minimum width=5.5, align = left, right, midway]{Columbimorphae\\Mirandornithes};
}

\onslide*<2>{%
\draw[ultra thick, black] (4.8, 1.45) -- (4.8, 9.2) node[right, midway] {Passerea contains \textasciitilde 10,000 species};

}


\onslide*<3>{\draw[ultra thick, orange5] (0.9,2.1) rectangle (4.8,2.9);
\draw [<-, orange5, ultra thick] (4.9,2.5) -- (6.5, 2.5) node[right] {Caprimulgiformes/Apodiformes}; 

\draw[ultra thick, orange5] (0.9,1.4) rectangle (4.8,1.7);
\draw [<-, orange5, ultra thick] (4.9,1.55) -- (6.5, 1.55) node[right] {Cuculiformes};

\draw[ultra thick, orange5] (0.9,3.07) rectangle (4.8,3.37);
\draw [<-, orange5, ultra thick] (4.9,3.22) -- (6.5, 3.22) node[right] {Gruiformes};
...
\begin{frame}[t]{Apodiformes: \highlight{Apodidae} — Chimney Swift}
...
\begin{frame}[t]{Apodiformes: \highlight{Trochilidae} — Hummingbirds}
\vspace{-0.5\baselineskip}
...
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{taxonomy_gruiformes}}
\begin{frame}[t]{\highlight{Gruiformes} has two families in Missouri: Gruidae (cranes) and \highlight{Rallidae} (rails).}
...
\node[anchor=south west, minimum width=5.5cm, align=right, color=white] at (0.56,0.45) {\tiny Virginia Rail by  \href{https://macaulaylibrary.org/asset/29069861}{Evan Lipton, Macaulay Library \textsc{ML29069861}}};
\end{tikzpicture}
...
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{taxonomy_american_coot}}
\begin{frame}[b]
...
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{taxonomy_rallidae}}
\begin{frame}[t]{Most Rallidae have longer bills and unlobed toes.}

	\tinyfill \textcolor{white}{Virginia Rail by  \href{https://flickr.com/photos/wildreturn/26985213537/}{Andy Reago \& Chrissy McLaren, Flickr, \ccby{2.0}}}
\end{frame}
}
